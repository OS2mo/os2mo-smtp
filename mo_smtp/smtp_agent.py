...
from fastramqpi.depends import Sessionmaker
...
from .notification_queue import process_pending
from .notification_queue import scheduler
...
def create_fastramqpi(**kwargs: Any) -> FastRAMQPI:
    ...
    if settings.enable_notification_queue:
        fastramqpi.add_lifespan_manager(scheduler(fastramqpi.get_context()))
    ...
    @app.post("/process_notification_queue", status_code=200, tags=["Queue"])
