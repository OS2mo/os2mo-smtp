...
from .dataloaders import get_address_data
from .dataloaders import get_employee_data
...
async def alert_on_rolebinding(
    ...
    if not ituser_uuid:
        ...
        return None
    return await generate_ituser_email(ituser_uuid, mo, email_client, email_settings)
...
async def alert_on_ituser(
    ...
    return await generate_ituser_email(event.subject, mo, email_client, email_settings)
...
async def generate_ituser_email(
    ...
    if template_context == _last_sent_messages.get(ituser_uuid):
    ...
    _last_sent_messages[ituser_uuid] = template_context
